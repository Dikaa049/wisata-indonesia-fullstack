  ...
  const [daftarKomentar, setDaftarKomentar] = useState([
    {
      id: 1,
      nama: "Budi Santoso",
      teks: "Pemandangannya luar biasa indah! Sangat direkomendasikan untuk liburan keluarga.",
      bintang: 5,
  ...
  return (
    <main className="w-full min-h-screen bg-white font-sans text-gray-800">
      ...
      <header className="w-full px-6 py-4 flex justify-between items-center bg-[#0f2e3c] text-white">
        ...
        <Link
          href="/destinasi"
          className="text-sm font-medium hover:text-teal-300 transition flex items-center gap-2"
        >
      ...
      <section className="w-full h-[60vh] relative">
        ...
        <div className="absolute bottom-10 left-6 md:left-20 text-white">
          <span className="bg-teal-500 text-white text-xs font-bold px-3 py-1 rounded-full uppercase tracking-widest mb-3 inline-block">
            Alam & Petualangan
          </span>
      ...
      <section className="max-w-6xl mx-auto px-6 md:px-12 py-16 grid grid-cols-1 lg:grid-cols-3 gap-16">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="prose prose-lg text-gray-600 leading-relaxed text-justify space-y-6">
            <p>
              Terletak di ujung barat Pulau Flores, <strong>Labuan Bajo</strong>{" "}
              dulunya adalah sebuah desa nelayan kecil yang kini telah menjelma
              menjadi salah satu destinasi wisata super prioritas di Indonesia.
              Gerbang menuju Taman Nasional Komodo ini menawarkan pesona alam
            ...
            */}
            ...
            <p>
              ...
              gugusan pulau-pulau eksotis seperti Pulau Padar dengan pemandangan
              bukitnya yang melengkung indah, hingga Pulau Komodo tempat
              berdiamnya kadal raksasa prasejarah yang legendaris.
            </p>
            <p>
              Jangan lewatkan pula keajaiban <em>Pink Beach</em> (Pantai Merah
              Muda) dengan pasirnya yang merona, serta surga bawah laut di Manta
              Point tempat Anda bisa berenang langsung bersama ikan Pari Manta
              yang anggun. Labuan Bajo adalah kanvas alam tempat petualangan dan
              kedamaian menyatu secara sempurna.
            </p>
          </div>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 sticky top-10">
            ...
            <p className="text-sm text-gray-500 mb-6">
              Pernah berkunjung ke sini? Beritahu wisatawan lain apa pendapat
              Anda.
            </p>
